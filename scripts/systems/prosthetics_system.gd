...
const PROSTHETICS: Dictionary = {
	...
	"SimpleProstheticLeg": {"part": "Leg", "efficiency": 0.85, "cost": {"Steel": 30, "Components": 2}, "tech_required": "Prosthetics"},
	"SimpleProstheticArm": {"part": "Arm", "efficiency": 0.85, "cost": {"Steel": 30, "Components": 2}, "tech_required": "Prosthetics"},
	"BionicLeg": {"part": "Leg", "efficiency": 1.25, "cost": {"Plasteel": 15, "Components": 4}, "tech_required": "Bionics"},
	"BionicArm": {"part": "Arm", "efficiency": 1.25, "cost": {"Plasteel": 15, "Components": 4}, "tech_required": "Bionics"},
	"BionicEye": {"part": "Eye", "efficiency": 1.5, "cost": {"Plasteel": 10, "Components": 3}, "tech_required": "Bionics"},
	"BionicEar": {"part": "Ear", "efficiency": 1.5, "cost": {"Plasteel": 8, "Components": 2}, "tech_required": "Bionics"},
